...
--
-- Host: 127.0.0.1
-- Tempo de geração: 11/09/2026 às 14:34
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_01_alunos_cursos`  AS SELECT `a`.`id_alunos` AS `codigo_aluno`, `a`.`nome` AS `nome_aluno`, `m`.`id_matricula` AS `codigo_matricula`, `m`.`situacao_da_matricula` AS `situacao_matricula`, `c`.`id_curso` AS `codigo_curso`, `c`.`nome_do_curso` AS `nome_curso` FROM (((`alunos` `a` join `matricula` `m` on(`a`.`id_alunos` = `m`.`id_alunos`)) join `turmas` `t` on(`m`.`id_turmas` = `t`.`id_turmas`)) join `cursos` `c` on(`t`.`id_cursos` = `c`.`id_curso`)) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_02_alunos_turmas_cursos`  AS SELECT `a`.`id_alunos` AS `codigo_aluno`, `a`.`nome` AS `aluno`, `t`.`id_turmas` AS `codigo_turma`, `c`.`id_curso` AS `codigo_curso`, `c`.`nome_do_curso` AS `curso`, `t`.`ano_letivo` AS `ano_letivo`, `t`.`turno` AS `turno`, `t`.`sala` AS `sala` FROM (((`alunos` `a` join `matricula` `m` on(`a`.`id_alunos` = `m`.`id_alunos`)) join `turmas` `t` on(`m`.`id_turmas` = `t`.`id_turmas`)) join `cursos` `c` on(`t`.`id_cursos` = `c`.`id_curso`)) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_03_disciplinas_professores`  AS SELECT `d`.`id_disciplinas` AS `codigo_disciplina`, `d`.`nome_disciplina` AS `disciplina`, `d`.`carga_horaria` AS `carga_horaria`, `p`.`id_professores` AS `codigo_professor`, `p`.`nome` AS `professor`, `dp`.`formacao` AS `formacao` FROM ((`disciplinas` `d` join `professores` `p` on(`d`.`id_professores` = `p`.`id_professores`)) left join `dados_pessoais` `dp` on(`p`.`id_dados` = `dp`.`id_dados`)) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_04_disciplinas_professores_cursos`  AS SELECT `c`.`id_curso` AS `codigo_curso`, `c`.`nome_do_curso` AS `curso`, `d`.`id_disciplinas` AS `codigo_disciplina`, `d`.`nome_disciplina` AS `disciplina`, `d`.`carga_horaria` AS `carga_horaria`, `p`.`id_professores` AS `codigo_professor`, `p`.`nome` AS `professor` FROM ((`cursos` `c` join `disciplinas` `d` on(`c`.`id_curso` = `d`.`id_cursos`)) join `professores` `p` on(`d`.`id_professores` = `p`.`id_professores`)) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_06_alunos_disciplinas_notas`  AS SELECT `a`.`id_alunos` AS `codigo_aluno`, `a`.`nome` AS `aluno`, `d`.`id_disciplinas` AS `codigo_disciplina`, `d`.`nome_disciplina` AS `disciplina`, `bd`.`nota_do_aluno` AS `nota`, `b`.`media_final` AS `media_final`, `b`.`situacao` AS `situacao_final` FROM ((((`alunos` `a` join `cursos` `c` on(`a`.`id_curso` = `c`.`id_curso`)) join `disciplinas` `d` on(`d`.`id_cursos` = `c`.`id_curso`)) join `boletins` `b` on(`b`.`id_disciplina` = `d`.`id_disciplinas`)) left join `boletins_disciplinas` `bd` on(`bd`.`id_boletins` = `b`.`id_boletim` and `bd`.`id_disciplinas` = `d`.`id_disciplinas`)) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_07_alunos_turmas_disciplinas_professores`  AS SELECT `a`.`nome` AS `aluno`, `t`.`id_turmas` AS `codigo_turma`, `c`.`nome_do_curso` AS `curso`, `d`.`nome_disciplina` AS `disciplina`, `p`.`nome` AS `professor`, `t`.`ano_letivo` AS `ano_letivo`, `t`.`turno` AS `turno` FROM (((((`alunos` `a` join `matricula` `m` on(`a`.`id_alunos` = `m`.`id_alunos`)) join `turmas` `t` on(`m`.`id_turmas` = `t`.`id_turmas`)) join `cursos` `c` on(`t`.`id_cursos` = `c`.`id_curso`)) join `disciplinas` `d` on(`c`.`id_curso` = `d`.`id_cursos`)) join `professores` `p` on(`d`.`id_professores` = `p`.`id_professores`)) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_08_desempenho_academico`  AS SELECT `a`.`id_alunos` AS `codigo_aluno`, `a`.`nome` AS `aluno`, `c`.`nome_do_curso` AS `curso`, `d`.`nome_disciplina` AS `disciplina`, `b`.`media_final` AS `media_final`, `b`.`frequencia` AS `frequencia`, `b`.`situacao` AS `situacao_final` FROM (((`alunos` `a` join `cursos` `c` on(`a`.`id_curso` = `c`.`id_curso`)) join `disciplinas` `d` on(`d`.`id_cursos` = `c`.`id_curso`)) join `boletins` `b` on(`b`.`id_disciplina` = `d`.`id_disciplinas`)) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_09_situacao_matriculas`  AS SELECT `a`.`id_alunos` AS `codigo_aluno`, `a`.`nome` AS `aluno`, `c`.`nome_do_curso` AS `curso`, `t`.`id_turmas` AS `codigo_turma`, `m`.`data_matricula` AS `data_matricula`, `m`.`situacao_da_matricula` AS `situacao_matricula`, `t`.`ano_letivo` AS `ano_letivo`, `t`.`turno` AS `turno` FROM (((`alunos` `a` join `matricula` `m` on(`a`.`id_alunos` = `m`.`id_alunos`)) join `turmas` `t` on(`m`.`id_turmas` = `t`.`id_turmas`)) join `cursos` `c` on(`t`.`id_cursos` = `c`.`id_curso`)) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_10_relatorio_academico`  AS SELECT `a`.`id_alunos` AS `codigo_aluno`, `a`.`nome` AS `aluno`, `c`.`nome_do_curso` AS `curso`, `t`.`id_turmas` AS `codigo_turma`, `d`.`nome_disciplina` AS `disciplina`, `p`.`nome` AS `professor`, `b`.`media_final` AS `media_final`, `b`.`frequencia` AS `frequencia`, `b`.`situacao` AS `situacao_final` FROM ((((((`alunos` `a` join `matricula` `m` on(`a`.`id_alunos` = `m`.`id_alunos`)) join `turmas` `t` on(`m`.`id_turmas` = `t`.`id_turmas`)) join `cursos` `c` on(`t`.`id_cursos` = `c`.`id_curso`)) join `disciplinas` `d` on(`c`.`id_curso` = `d`.`id_cursos`)) join `professores` `p` on(`d`.`id_professores` = `p`.`id_professores`)) left join `boletins` `b` on(`d`.`id_disciplinas` = `b`.`id_disciplina`)) ;
